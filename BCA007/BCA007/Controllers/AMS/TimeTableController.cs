...
namespace BCA007.Controllers.CMS
{
    ...
    {
        private readonly ITimeTableService _serv;
        ...
        [HttpPost("create")]
        public async Task<ActionResult<TimetableDto>> Create(TimetableDto dto)
        {
        ...
        [HttpPut("edit")]
        public async Task<ActionResult<TimetableDto>> Update(TimetableDto dto)
        {
            if (!ModelState.IsValid)
                return BadRequest(ModelState);
            try
